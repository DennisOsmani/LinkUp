...
export default function EditModal({
    ...
    const [event, setEvent] = useState<IEventDTO>({
        ...
        minCapacity: eventProp?.minCapacity?.toString(),
        maxCapacity: eventProp?.maxCapacity?.toString(),
    });
    ...
    const handleUpdateEvent = async () => {
        ...
        try {
            const adjustedDateStart = new Date(
                ...
                new Date(event.eventDateTimeEnd).getTimezoneOffset() * 60000
            );
            ...
            const adjustedDateEnd = new Date(
                ...
                new Date(event.eventDateTimeStart).getTimezoneOffset() * 60000
            );
                ...
                <View style={styles.inputContainer}>
                    ...
                    <View style={styles.datetimepickerBox}>
                        ...
                        <RNDateTimePicker
                            ...
                            minimumDate={new Date(event.eventDateTimeStart.toString())}
                        />
                    </View>
